...
type"""+delim+'1'+delim+"""How to interpret the water level
waterlevel"""+delim+'16'+delim+"""Water level in centimeters
datum"""+delim+'2'+delim+"""What reference datum applies to the value
reserved"""+delim+'14'+delim+"""Reserved bits for future use
Total bits"""+delim+"""144"""+delim+"""Appears to take 1 slot with 24 pad bits to fill the last slot""")
...
def addMsgOptions(parser):
    ...
    parser.add_option('--pos_latitude-field', dest='pos_latitudeField',default=Decimal('91'),metavar='decimal',type='string'
        ,help='Field parameter value [default: %default]')
    parser.add_option('--type-field', dest='typeField',metavar='uint',type='int'
        ,help='Field parameter value [default: %default]')
