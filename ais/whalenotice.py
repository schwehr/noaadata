...
month"""+delim+'4'+delim+"""Time of most recent whale detection.  UTC month 1..12
...
sec"""+delim+'6'+delim+"""Time of most recent whale detection.  UTC seconds
stationid"""+delim+'42'+delim+"""Identifier of the station that detected the whale.  (e.g. which buoy)
...
timetoexpire"""+delim+'16'+delim+"""Seconds from the detection time until the notice expires
radius"""+delim+'16'+delim+"""Distance from center of detection zone (lat/lon above)
Total bits"""+delim+"""223"""+delim+"""Appears to take 2 slots with 201 pad bits to fill the last slot""")
...
def addMsgOptions(parser):
    ...
    parser.add_option('--timetoexpire-field', dest='timetoexpireField',default=0,metavar='uint',type='int'
        ,help='Field parameter value [default: %default]')
    parser.add_option('--radius-field', dest='radiusField',default=65534,metavar='uint',type='int'
        ,help='Field parameter value [default: %default]')
