...
#class TestGrid(unittest.TestCase):
    ...
    def testInit30(self):
        ...
        self.assertAlmostEqual(g.minx,.5)
    ...
    def testInit40(self):
        ...
        self.assertAlmostEqual(g.minx,-.5)
        self.assertAlmostEqual(g.maxx,.5)
        self.assertAlmostEqual(g.miny,-1.5)
        self.assertAlmostEqual(g.maxy,4.5)
    ...
    def testInit50(self):
        ...
        self.assertAlmostEqual(g.miny,.1)
        self.assertAlmostEqual(g.maxy,1)
    ...
    def testInit51(self):
        ...
        self.assertAlmostEqual(g.minx,.1)
        self.assertAlmostEqual(g.maxx,1)
...
#class TestGrid_GetLineCells_PlusPoint5Origin(unittest.TestCase):
    ...
    def testGetLineCells100(self):
        ...
        self.assertEqual(g.xNumCells,10); self.assertEqual(g.yNumCells,1)
...
class TestGridLength(unittest.TestCase):
    ...
    def testSingleCell(self):
        ...
        self.assertAlmostEqual(0.,frac1)
        self.assertAlmostEqual(1.,frac2)
        self.assertAlmostEqual(0.5,dist)

        # Single cell - horz
        r = g.getLineCellsWithCrossings(0,.25, 0.,.75,verbose=True)
        self.assertEqual((0,0),cell)
        self.assertEqual(0.,frac1)
        self.assertEqual(1.,frac2)
        self.assertAlmostEqual(0.5,dist)
    ...
    def testHorizontal1(self):
        ...
        self.assertEqual((0,1),cell)
        self.assertEqual(0.,frac1)
        self.assertAlmostEqual(.25/2.,frac2)
        self.assertAlmostEqual(0.5,dist)

        cell,frac1,frac2,dist = r[-1]
        self.assertEqual((4,1),cell)
        self.assertAlmostEqual(1 - (0.25/2.),frac1)
        self.assertEqual(1.,frac2)
        self.assertAlmostEqual(0.5,dist)
