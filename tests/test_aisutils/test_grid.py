...
class TestGrid(unittest.TestCase):
    ...
    def testInit10(self):
        "init with unit grid"
        g = Grid(0, 0, 1, 1, 1)
        assert g.xNumCells == 1
        assert g.yNumCells == 1
    ...
    def testInit50(self):
        ...
        g = Grid(0, 0, 1, 1, 0.1)
        assert g.xNumCells == 10
        assert g.yNumCells == 10
        self.assertAlmostEqual(g.maxx, 1)
        self.assertAlmostEqual(g.maxy, 1)
    ...
    def testInit50(self):
        ...
        assert g.xNumCells == 11
        assert g.yNumCells == 9
    ...
    def testInit51(self):
        ...
        assert g.xNumCells == 9
        assert g.yNumCells == 11
...
class TestGrid_GetLineCells_Non0Origin(unittest.TestCase):
    ...
    def testGetLineCells200(self):
        ...
        assert g.xNumCells == 4
        assert g.yNumCells == 4
        assert cells == [(0, 0), (1, 0), (1, 1)]
...
class TestGrid_GetLineCells_stepsizes(unittest.TestCase):
    ...
    def testGetLineCells100(self):
        ...
        assert g.xNumCells in (10, 11)
        assert g.yNumCells in (2, 3)
    ...
    def testGetLineCells200(self):
        ...
        assert g.xNumCells in (4, 5)
        assert g.yNumCells in (4, 5)
        cells = g.getLineCells(
            (ss * 0.9) + self.xmin,
            (0.1 * ss) + self.ymin,
            (1.5 * ss) + self.xmin,
...
class TestGrid_GetMultiSegLineCells(unittest.TestCase):
    ...
    def testSegs4(self):
        ...
        assert cells == [(0, 0), (1, 0), (1, 1), (0, 1), (0, 0)]
    ...
    def testSegs4_1(self):
        ...
        assert cells == [(0, 0), (1, 0), (2, 0), (3, 0), (3, 1), (3, 2), (3, 3)]
