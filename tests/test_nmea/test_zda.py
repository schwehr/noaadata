import pytest
import calendar
from nmea.zda import zdaDecode, zdaEpochSeconds, ggaDecode, zdaDict2TIMESTAMP
...
def test_gga_decode_validate_true():
    ...
    sentence = '$GPGGA,152009.00,3652.4800,N,07620.0200,W,1,11,0.8,3.669,M,-34.50,M,,*57'
...
def test_zda_dict2timestamp():
    zda_dict = {
        'hour': 11, 'min': 0, 'hsec': 0, 'sec': 3,
        'mon': 3, 'year': 2006, 'day': 27
    }
