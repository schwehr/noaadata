...
def encode(params, validate=False):
    ...
    if "offset1" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["offset1"]), 12)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 12))
    if "numslots1" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["numslots1"]), 4)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 4))
    if "timeout1" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["timeout1"]), 3)
        )
    else:
    ...
    if "offset2" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["offset2"]), 12)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 12))
    if "numslots2" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["numslots2"]), 4)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 4))
    if "timeout2" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["timeout2"]), 3)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 3))
    ...
    if "offset3" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["offset3"]), 12)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 12))
    if "numslots3" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["numslots3"]), 4)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 4))
    if "timeout3" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["timeout3"]), 3)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 3))
    ...
    if "offset4" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["offset4"]), 12)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 12))
    if "numslots4" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["numslots4"]), 4)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 4))
    if "timeout4" in params:
        bvList.append(
            binary.setBitVectorSize(BitVector.from_int(params["timeout4"]), 3)
        )
    else:
        bvList.append(binary.setBitVectorSize(BitVector.from_int(0), 3))
...
def printFields(
    ...
    if format == "std":
        ...
        if "offset1" in params:
            out.write("    offset1:          " + str(params["offset1"]) + "\n")
        if "numslots1" in params:
            out.write("    numslots1:        " + str(params["numslots1"]) + "\n")
        if "timeout1" in params:
            out.write("    timeout1:         " + str(params["timeout1"]) + "\n")
        if "increment1" in params:
            out.write("    increment1:       " + str(params["increment1"]) + "\n")
        if "offset2" in params:
            out.write("    offset2:          " + str(params["offset2"]) + "\n")
        if "numslots2" in params:
            out.write("    numslots2:        " + str(params["numslots2"]) + "\n")
        if "timeout2" in params:
            out.write("    timeout2:         " + str(params["timeout2"]) + "\n")
        if "increment2" in params:
            out.write("    increment2:       " + str(params["increment2"]) + "\n")
        if "offset3" in params:
            out.write("    offset3:          " + str(params["offset3"]) + "\n")
        if "numslots3" in params:
            out.write("    numslots3:        " + str(params["numslots3"]) + "\n")
        if "timeout3" in params:
            out.write("    timeout3:         " + str(params["timeout3"]) + "\n")
        if "increment3" in params:
            out.write("    increment3:       " + str(params["increment3"]) + "\n")
        if "offset4" in params:
            out.write("    offset4:          " + str(params["offset4"]) + "\n")
        if "numslots4" in params:
            out.write("    numslots4:        " + str(params["numslots4"]) + "\n")
        if "timeout4" in params:
            out.write("    timeout4:         " + str(params["timeout4"]) + "\n")
        if "increment4" in params:
...
def sqlCreate(
    ...
    if "Spare" in fields:
        c.addInt("Spare")
    if "offset1" in fields:
        c.addInt("offset1")
    if "numslots1" in fields:
        c.addInt("numslots1")
    if "timeout1" in fields:
        c.addInt("timeout1")
    if "increment1" in fields:
        c.addInt("increment1")
    if "offset2" in fields:
        c.addInt("offset2")
    if "numslots2" in fields:
        c.addInt("numslots2")
    if "timeout2" in fields:
        c.addInt("timeout2")
    if "increment2" in fields:
        c.addInt("increment2")
    if "offset3" in fields:
        c.addInt("offset3")
    if "numslots3" in fields:
        c.addInt("numslots3")
    if "timeout3" in fields:
        c.addInt("timeout3")
    if "increment3" in fields:
        c.addInt("increment3")
    if "offset4" in fields:
        c.addInt("offset4")
    if "numslots4" in fields:
        c.addInt("numslots4")
    if "timeout4" in fields:
        c.addInt("timeout4")
    if "increment4" in fields:
        c.addInt("increment4")
    if "variablespare" in fields:
        c.addInt("variablespare")
...
increment1"""
        ...
        + "11"
        + delim
        + """Increment to repeast reservation of this block
offset2"""
        + delim
        + "12"
        + delim
...
increment2"""
        ...
        + "11"
        + delim
        + """Increment to repeast reservation of this block (optional)
offset3"""
        + delim
        + "12"
        + delim
...
variablespare"""
        ...
        + "6"
        + delim
        + """This field is a serious pain.  This padding makes the message byte aligned
Total bits"""
        + delim
        + """166"""
        + delim
        + """Appears to take 1 slot with 2 pad bits to fill the last slot"""
    )
