...
def encode(params, validate=False):
    ...
    if "center1_longitude" in params:
        bvList.append(
            binary.bvFromSignedInt(
                int(Decimal(params["center1_longitude"]) * Decimal("600000")), 28
            )
        )
    else:
    ...
    if "center1_latitude" in params:
        bvList.append(
            binary.bvFromSignedInt(
                int(Decimal(params["center1_latitude"]) * Decimal("600000")), 27
            )
        )
    else:
    ...
    if "center2_longitude" in params:
        bvList.append(
            binary.bvFromSignedInt(
                int(Decimal(params["center2_longitude"]) * Decimal("600000")), 28
            )
        )
    else:
        bvList.append(binary.bvFromSignedInt(108600000, 28))
    if "center2_latitude" in params:
        bvList.append(
            binary.bvFromSignedInt(
                int(Decimal(params["center2_latitude"]) * Decimal("600000")), 27
            )
        )
    else:
        bvList.append(binary.bvFromSignedInt(54600000, 27))
    ...
    if "center3_longitude" in params:
        bvList.append(
            binary.bvFromSignedInt(
                int(Decimal(params["center3_longitude"]) * Decimal("600000")), 28
            )
        )
    else:
        bvList.append(binary.bvFromSignedInt(108600000, 28))
    if "center3_latitude" in params:
        bvList.append(
            binary.bvFromSignedInt(
                int(Decimal(params["center3_latitude"]) * Decimal("600000")), 27
            )
        )
    else:
        bvList.append(binary.bvFromSignedInt(54600000, 27))
...
def decode(bv, validate=False):
    ...
    r["center1_longitude"] = Decimal(binary.signedIntFromBV(bv[94:122])) / Decimal(
        "600000"
    )
    r["center1_latitude"] = Decimal(binary.signedIntFromBV(bv[122:149])) / Decimal(
        "600000"
    )
    ...
    r["center2_longitude"] = Decimal(binary.signedIntFromBV(bv[205:233])) / Decimal(
        "600000"
    )
    r["center2_latitude"] = Decimal(binary.signedIntFromBV(bv[233:260])) / Decimal(
        "600000"
    )
    ...
    r["center3_longitude"] = Decimal(binary.signedIntFromBV(bv[316:344])) / Decimal(
        "600000"
    )
    r["center3_latitude"] = Decimal(binary.signedIntFromBV(bv[344:371])) / Decimal(
        "600000"
    )
...
def printHtml(params, out=sys.stdout):
    ...
    if "timetoexpire1" in params:
        ...
        if str(params["timetoexpire1"]) in timetoexpire1DecodeLut:
            out.write(
                "<td>" + timetoexpire1DecodeLut[str(params["timetoexpire1"])] + "</td>"
            )
        else:
            out.write("<td><i>Missing LUT entry</i></td>")
    ...
    if "timetoexpire2" in params:
        ...
        if str(params["timetoexpire2"]) in timetoexpire2DecodeLut:
            out.write(
                "<td>" + timetoexpire2DecodeLut[str(params["timetoexpire2"])] + "</td>"
            )
        else:
            out.write("<td><i>Missing LUT entry</i></td>")
    out.write("<td>seconds</td>\n")
    ...
    if "timetoexpire3" in params:
        ...
        if str(params["timetoexpire3"]) in timetoexpire3DecodeLut:
            out.write(
                "<td>" + timetoexpire3DecodeLut[str(params["timetoexpire3"])] + "</td>"
            )
        else:
            out.write("<td><i>Missing LUT entry</i></td>")
    out.write("<td>seconds</td>\n")
...
def printFields(
    ...
    if format == "std":
        ...
        if "efid" in params:
            out.write("    efid:               " + str(params["efid"]) + "\n")
        if "numreports" in params:
            out.write("    numreports:         " + str(params["numreports"]) + "\n")
        if "stationid1" in params:
            out.write("    stationid1:         " + str(params["stationid1"]) + "\n")
        if "time1_day" in params:
            out.write("    time1_day:          " + str(params["time1_day"]) + "\n")
        if "time1_hour" in params:
            out.write("    time1_hour:         " + str(params["time1_hour"]) + "\n")
        if "time1_min" in params:
            out.write("    time1_min:          " + str(params["time1_min"]) + "\n")
        if "center1_longitude" in params:
            out.write(
                "    center1_longitude:  " + str(params["center1_longitude"]) + "\n"
            )
        if "center1_latitude" in params:
            out.write(
                "    center1_latitude:   " + str(params["center1_latitude"]) + "\n"
            )
        if "timetoexpire1" in params:
            out.write("    timetoexpire1:      " + str(params["timetoexpire1"]) + "\n")
        if "radius1" in params:
            out.write("    radius1:            " + str(params["radius1"]) + "\n")
        if "stationid2" in params:
            out.write("    stationid2:         " + str(params["stationid2"]) + "\n")
        if "time2_day" in params:
            out.write("    time2_day:          " + str(params["time2_day"]) + "\n")
        if "time2_hour" in params:
            out.write("    time2_hour:         " + str(params["time2_hour"]) + "\n")
        if "time2_min" in params:
            out.write("    time2_min:          " + str(params["time2_min"]) + "\n")
        if "center2_longitude" in params:
            out.write(
                "    center2_longitude:  " + str(params["center2_longitude"]) + "\n"
            )
        if "center2_latitude" in params:
            out.write(
                "    center2_latitude:   " + str(params["center2_latitude"]) + "\n"
            )
        if "timetoexpire2" in params:
            out.write("    timetoexpire2:      " + str(params["timetoexpire2"]) + "\n")
        if "radius2" in params:
            out.write("    radius2:            " + str(params["radius2"]) + "\n")
        if "stationid3" in params:
            out.write("    stationid3:         " + str(params["stationid3"]) + "\n")
        if "time3_day" in params:
            out.write("    time3_day:          " + str(params["time3_day"]) + "\n")
        if "time3_hour" in params:
            out.write("    time3_hour:         " + str(params["time3_hour"]) + "\n")
        if "time3_min" in params:
            out.write("    time3_min:          " + str(params["time3_min"]) + "\n")
        if "center3_longitude" in params:
            out.write(
                "    center3_longitude:  " + str(params["center3_longitude"]) + "\n"
            )
        if "center3_latitude" in params:
            out.write(
                "    center3_latitude:   " + str(params["center3_latitude"]) + "\n"
            )
        if "timetoexpire3" in params:
            out.write("    timetoexpire3:      " + str(params["timetoexpire3"]) + "\n")
        if "radius3" in params:
...
def sqlCreate(
    ...
    if "efid" in fields:
        c.addInt("efid")
    if "numreports" in fields:
        c.addInt("numreports")
    if "stationid1" in fields:
        c.addInt("stationid1")
    if "time1_day" in fields:
        c.addInt("time1_day")
    if "time1_hour" in fields:
        c.addInt("time1_hour")
    ...
    if "radius1" in fields:
        c.addInt("radius1")
    if "stationid2" in fields:
        c.addInt("stationid2")
    if "time2_day" in fields:
        c.addInt("time2_day")
    if "time2_hour" in fields:
        c.addInt("time2_hour")
    ...
    if "radius2" in fields:
        c.addInt("radius2")
    if "stationid3" in fields:
        c.addInt("stationid3")
    if "time3_day" in fields:
        c.addInt("time3_day")
    if "time3_hour" in fields:
        c.addInt("time3_hour")
...
dac"""
        ...
        + "10"
        + delim
        + """Designated Area Code - 366 for the United States
fid"""
        + delim
        + "6"
        + delim
        + """Functional IDentifier - 63 for the Whale Notice
efid"""
        + delim
        + "12"
        + delim
        + """Extended Functional IDentifier.  1 for the Whale Notice (dac+fid+efid defines the exact message type)
numreports"""
        + delim
        + "2"
        + delim
        + """Number of detection reports filled out in this message
stationid1"""
        + delim
        + "8"
        + delim
        + """Identifier of the station that recorded the whale.  Usually a number.
time1_day"""
        + delim
        + "5"
        + delim
        + """Time of most recent whale detection.  UTC day of the month 1..31
time1_hour"""
        + delim
        + "5"
        + delim
        + """Time of most recent whale detection.  UTC hours 0..23
time1_min"""
        + delim
        + "6"
        + delim
        + """Time of most recent whale detection.  UTC minutes
center1_longitude"""
        + delim
        + "28"
        + delim
        + """Center of the detection zone.  East West location
center1_latitude"""
        + delim
        + "27"
        + delim
        + """Center of the detection zone.  North South location
timetoexpire1"""
        + delim
        + "16"
        + delim
        + """Seconds from the detection time until the notice expires
radius1"""
        + delim
        + "16"
        + delim
        + """Distance from center of detection zone (lat/lon above)
stationid2"""
        + delim
        + "8"
        + delim
...
def addMsgOptions(parser):
    ...
    parser.add_option(
        "--center1_longitude-field",
        dest="center1_longitudeField",
        default=Decimal("181"),
        metavar="decimal",
        type="string",
        help="Field parameter value [default: %default]",
    ...
    parser.add_option(
        "--center1_latitude-field",
        dest="center1_latitudeField",
        default=Decimal("91"),
        metavar="decimal",
        type="string",
        help="Field parameter value [default: %default]",
    ...
    parser.add_option(
        "--center2_longitude-field",
        dest="center2_longitudeField",
        default=Decimal("181"),
        metavar="decimal",
        type="string",
        help="Field parameter value [default: %default]",
    ...
    parser.add_option(
        "--center2_latitude-field",
        dest="center2_latitudeField",
        default=Decimal("91"),
        metavar="decimal",
        type="string",
        help="Field parameter value [default: %default]",
    ...
    parser.add_option(
        "--center3_longitude-field",
        dest="center3_longitudeField",
        default=Decimal("181"),
        metavar="decimal",
        type="string",
        help="Field parameter value [default: %default]",
    ...
    parser.add_option(
        "--center3_latitude-field",
        dest="center3_latitudeField",
        default=Decimal("91"),
        metavar="decimal",
        type="string",
        help="Field parameter value [default: %default]",
