...
datumDecodeLut = {
    ...
    "10": "Pool",
    "11": "Gauge",
    "31": "Unknown/Unavailable",
}  # datumEncodeLut

sourceEncodeLut = {
    "No data": "0",
    "Realtime sensor data": "1",
    "Raw realtime sensor data - no validation": "2",
    "Predicted water level - tidal data generated by using harmonic analysis": "3",
    "Forecast water level - tidal data generated by use of a hydrodynamic model": "4",
    "Reserved": "5",
    "Reserved": "6",
    "Reserved": "7",
}  # sourceEncodeLut
...
sourceDecodeLut = {
    ...
    "2": "Raw realtime sensor data - no validation",
    "3": "Predicted water level - tidal data generated by using harmonic analysis",
    "4": "Forecast water level - tidal data generated by use of a hydrodynamic model",
    "5": "Reserved",
    "6": "Reserved",
    "7": "Reserved",
}  # sourceEncodeLut
...
\\end{tabular}
\\caption{AIS message number 8: Water level report.  This is }
...
month"""
        ...
        + "4"
        + delim
        + """Time the measurement represents  month 1..12
day"""
        + delim
        + "5"
        + delim
        + """Time the measurement represents  day of the month 1..31
hour"""
        + delim
        + "5"
        + delim
        + """Time the measurement represents  UTC hours 0..23
min"""
        + delim
        + "6"
        + delim
        + """Time the measurement represents  minutes
stationid"""
        + delim
        + "42"
        + delim
...
sigma"""
        ...
        + "7"
        + delim
        + """Standard deviation of 1 second samples used to compute the water level height.  FIX: is this the correct description of sigma?
source"""
        + delim
        + "3"
        + delim
        + """How the water level was derived
Total bits"""
        + delim
        + """149"""
        + delim
        + """Appears to take 1 slot with 19 pad bits to fill the last slot"""
    )
