...
def printFields(
    ...
    """Print a sls_wind message to stdout.
...
def sqlCreate(
    ...
    if fields is None:
        fields = fieldList
    c = sqlhelp.create("sls_wind", dbType=dbType)
    c.addPrimaryKey()
...
def sqlInsert(params, extraParams=None, dbType="postgres"):
    ...
    i = sqlhelp.insert("sls_wind", dbType=dbType)
...
class Testsls_wind(unittest.TestCase):
...
def addMsgOptions(parser):
    parser.add_option(
        ...
        default=False,
        action="store_true",
        help='decode a "sls_wind" AIS message',
    )
    parser.add_option(
        "-e",
        "--encode",
        ...
        default=False,
        action="store_true",
        help='encode a "sls_wind" AIS message',
    )
    parser.add_option(
        "--time_month-field",
