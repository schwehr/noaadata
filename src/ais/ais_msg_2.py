...
def encode(params, validate=False):
    ...
    Fields in params:
      - MessageID(uint): AIS message number.  Must be 1 (field automatically set to "2")
    ...
    bvList = []
    bvList.append(binary.setBitVectorSize(BitVector.from_int(2), 6))
...
\\end{tabular}
\\caption{AIS message number 2: Scheduled position report}
\\label{tab:position}
\\end{table}
""")
