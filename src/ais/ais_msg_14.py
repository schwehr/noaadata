...
def encode(params, validate=False):
    ...
    bvList = []
    bvList.append(binary.setBitVectorSize(BitVector.from_int(14), 6))
...
Total bits"""
        ...
        + """39"""
        + delim
        + """Appears to take 1 slot with 129 pad bits to fill the last slot"""
    )
