...
def main():
    ...
    col = 0
    ws_report.write(ws_report_row, col, "Report generated by noaadata.ais_5report.py")
    col += 1
    ws_report_row += 1

    col = 0
    if len(args) > 1:
        ws_report.write(ws_report_row, col, "Input files:")
        col += 1
    else:
        ws_report.write(ws_report_row, col, "Input file:")
        col += 1
    for filename in args:
        ws_report.write(ws_report_row, col, filename)
        col += 1
    ws_report_row += 1

    col = 0
    ws_report.write(ws_report_row, col, "MMSI")
    col += 1
    ws_report.write(ws_report_row, col, "IMOnumber")
    col += 1
    ws_report.write(ws_report_row, col, "callsign")
    col += 1
    ws_report.write(ws_report_row, col, "name")
    col += 1
    ws_report.write(ws_report_row, col, "shipandcargo")
    col += 1
    ws_report.write(ws_report_row, col, "dimA")
    col += 1
    ws_report.write(ws_report_row, col, "dimB")
    col += 1
    ws_report.write(ws_report_row, col, "dimC")
    col += 1
    ws_report.write(ws_report_row, col, "dimD")
    col += 1
    ws_report.write(ws_report_row, col, "ETAmin")
    col += 1
    ws_report.write(ws_report_row, col, "ETAhour")
    col += 1
    ws_report.write(ws_report_row, col, "draught")
    col += 1
    ws_report.write(ws_report_row, col, "destination")
    col += 1
    ws_report.write(ws_report_row, col, "first reported (UTCsec)")
    col += 1
    ...
    for mmsi in ships:
        ...
        for line in msgsByShip[mmsi]:
            ...
            col += 1
            ws_report.write(ws_report_row, col, r["ETAhour"])
            col += 1
            ws_report.write(ws_report_row, col, float(r["draught"]))
            col += 1
            ws_report.write(ws_report_row, col, aisstring.unpad(r["destination"]))
            col += 1
            ws_report.write(ws_report_row, col, timestamp)
            col += 1
