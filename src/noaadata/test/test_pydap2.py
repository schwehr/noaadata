...
pytest.skip(
    "Legacy OPeNDAP client (dap.client) unavailable on Python 3",
...
if __name__ == "__main__":
    ...
    reqStr = urllib.parse.quote(
        '_STATION_ID="1615680"&_BEGIN_DATE="20060101 10:06"&_END_DATE="20060101 10:06"&_DATUM="MLLW"'
    )
    print("reqStr:", reqStr)
